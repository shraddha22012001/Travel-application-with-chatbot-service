...
public class MaintainHoteldetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maintain_hoteldetails);
        productId=getIntent().getStringExtra("pid");
        productsRef= FirebaseDatabase.getInstance().getReference().child("Hotels").child(productId);
    ...
    private void deleteProduct() {
        productsRef.removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                Toast.makeText(MaintainHoteldetailsActivity.this,"Place removed Successfully",Toast.LENGTH_SHORT).show();
                finish();
            }
        });
    }
            ...
            productsRef.updateChildren(productMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if(task.isSuccessful()){
                        Toast.makeText(MaintainHoteldetailsActivity.this,"Changes applied successfully",Toast.LENGTH_SHORT).show();
                        finish();
                    }
                }
            });

...
public class AddNewRestuarantActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_new_restuarant);
        Toast.makeText(AddNewRestuarantActivity.this,"Welcome",Toast.LENGTH_SHORT).show();
        ProductImageRef= FirebaseStorage.getInstance().getReference().child("Product Images");
        ProductRef= FirebaseDatabase.getInstance().getReference().child("Restaurants");
    ...
    private void StoreProductInformation()
    {
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(AddNewRestuarantActivity.this,"Error"+ message,Toast.LENGTH_SHORT).show();
                loadingBar.dismiss();
            }
        }).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            @Override
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                Toast.makeText(AddNewRestuarantActivity.this,"Image Uploaded Successfully..",Toast.LENGTH_SHORT).show();
                ...
                Task<Uri> uriTask=uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(AddNewRestuarantActivity.this, "got Place Image url  Successfully..", Toast.LENGTH_SHORT).show();
        ...
        ProductRef.child(ProductRandomKey).updateChildren(productMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    ...
                    loadingBar.dismiss();
                    finish();
                    Toast.makeText(AddNewRestuarantActivity.this,"Place added successfully",Toast.LENGTH_SHORT).show();
                }
                else{
                    loadingBar.dismiss();

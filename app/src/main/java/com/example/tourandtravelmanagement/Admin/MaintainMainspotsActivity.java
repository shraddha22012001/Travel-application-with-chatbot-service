...
import com.example.tourandtravelmanagement.User.MainSpotsDetailsActivity;
...
public class MaintainMainspotsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maintain_mainspots);
        ...
        FirebaseRecyclerAdapter<Mainspots, ProductViewHolder> adapter=new FirebaseRecyclerAdapter<Mainspots, ProductViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull ProductViewHolder productViewHolder, int i, @NonNull Mainspots hotels) {
                ...
                productViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent=new Intent(MaintainMainspotsActivity.this, MaintainMainspotsDetailsActivity.class);
